...
const ContactUs = () => {
    return (
        <motion.div
            ...
            id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700'>
            ...
            <motion.form
                ...
                <div className='sm:col-span-2'>
                    ...
                    <textarea rows={8} placeholder='Enter your message' className='w-full p-3 text-sm outline-none rounded-lg border border-gray-300' required/>
                </div>
