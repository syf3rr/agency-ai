...
const Teams = () => {
    return (
        <motion.div
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5 select-none'>
                {teamData.map((team, index)=>(
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        key={index} className='flex max-sm:flex-col items-center gap-5 p-4 rounded-xl border border-gray-100 bg-white shadow-xl shadow-gray-100 hover:scale-103 transition-all duration-400'>
